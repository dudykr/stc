...
declare function app<State, Actions extends ActionsObject<State>>(
...
declare function app2<State, Actions extends ActionsObject<State>>(
...
declare function app3<State, Actions extends ActionsArray<State>>(
  obj: Options<State, Actions>
): void;
...
declare function App4<State, Actions extends ActionsObjectOr<State>>(
  props: Options<State, Actions>["actions"] & { state: State }
): JSX.Element;

const a = <App4 state={100} foo={(s) => s} />; // TODO(kdy1): should be number => number, but JSX resolution is missing an inferential pass
