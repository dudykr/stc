...
use stc_ts_types::{
    ArcCowType, Class, ClassMember, ClassProperty, KeywordType, KeywordTypeMetadata, LitType, Method, MethodSignature, PropertySignature,
...
impl Analyzer<'_, '_> {
    ...
    /// }
    /// ```
    pub(crate) fn keyof(&mut self, span: Span, ty: &Type) -> VResult<ArcCowType> {
