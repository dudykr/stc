...
use stc_ts_types::{
    type_id::SymbolId, Alias, ArcCowType, Array, Class, ClassDef, ClassMember, ClassProperty, CommonTypeMetadata, Function, Id, IdCtx,
...
impl Analyzer<'_, '_> {
    ...
    fn add_call_facts(&mut self, params: &[FnParam], args: &[RExprOrSpread], ret_ty: &mut Type) {
        ...
        if let Type::Predicate(p) = ret_ty {
            let ctx = Ctx {
